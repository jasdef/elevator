    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <form id="tab" name="create_custiner" action="<?= site_url("/Personal/personal_create") ?>" method="post">
                <button class="btn btn-primary" type="submit"><i class="icon-plus"></i> 存儲</button>
                <button class="btn" type="button" onclick="history.back()"><i class="icon-ban-circle"></i> 取消</button>
                <div class="well">

        ...
        <div class="row-fluid">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <div class="well">
                        <h4><a href="<?=base_url("/Form/transaction_home")?>?transaction_id=<?=$this->data['RowTransactiondata']['id'];?>"" >[保固單]</a></h4>
                        ...
                        <table class="table sortable">
                            ...
                            <tbody>
                            <?php if(!empty($this->data['RowRowWarrantydata'])):?>
                                    <tr>
                                        <td><?=$this->data['RowRowWarrantydata']['id'] ?></td>
                                        <td><?=$this->data['RowTransactiondata']['id'] ?></td>
                                        <td><?=$this->data['RowRowWarrantydata']['customer'] ?></td>
                                        <td><?=$this->data['RowRowWarrantydata']['contacter_1'] ?></td>
                                        <td><?=$this->data['RowRowWarrantydata']['address'] ?></td>
                                        <td><?=$this->data['RowRowWarrantydata']['tel_1'] ?></td>
                                        <td>
                                            <a href="<?=base_url("/Warranty/view_warranty_view")?>/warranty_id/<?=$this->data['RowRowWarrantydata']['id'];?>" ><i class="icon-eye-open"></i></a>
                                        </td>
                                        <td>
                                            <a href="<?=base_url("/Warranty/edit_warranty")?>/warranty_id/<?=$this->data['RowRowWarrantydata']['id'];?>" ><i class="icon-pencil"></i></a>
                                        </td>
                                        <td>
                                            <a href="<?=base_url("/Warranty/delete_warranty")?>/warranty_id/<?=$this->data['RowRowWarrantydata']['id'];?>" ><i class="icon-remove"></i></a>
                                        </td>
                                        <td>
                                            <a href="<?=base_url("/Service/service_create_by_warranty/".$this->data['RowRowWarrantydata']['id']."")?>">產生保養單</a>
                                        </td>
                                    </tr>
                            <?php endif; ?>
                            </tbody>
                    ...
                    <div class="well">
                        ...
                        <table class="table sortable">
                            ...
                            <tbody>
                            <?php if(!empty($this->data['Servicedatalist'])):?>
                                <?php foreach ($this->data['Servicedatalist'] as $k=>$v):?>
                                    <tr>
                                        <td><?=$v['id'];?></td>
                                        <td><?=$v['service_month'];?></td>
                                        <td><?=$v['license'];?></td>
                                        <td><?=$v['Total_price'];?></td>
                                        <td><?=$v['status'];?></td>
                                        <td>
                                            <a href="<?=base_url("/service/edit_service")?>/service_id/<?=$v['id'];?>" ><i class="icon-pencil"></i></a>
                                        </td>
                                        <td>
                                            <a href="<?=base_url("/service/delete_service")?>/service_id/<?=$v['id'];  ?>" ><i class="icon-remove"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                            <?php else:?>
